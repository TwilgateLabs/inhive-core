...
Size: 208 lines across 1 file(s).

Files:
- `platform/mobile/mobile.go` (208 lines)

Public API:
- Types: `SetupOptions`
- Functions: `AddGrpcClientPublicKey`, `Close`, `ConvertToShareLinks`, `GetServerPublicKey`, `Parse`, `Pause`, `Setup`, `Start`, `StartPingOnly`, `Stop`, `Wake`

Imported by: nothing found in scanned tree (leaf module, entry point, or only reached via reflection/DI).

Tests referencing this module: `platform/mobile/mobile_start_test.go`

## `v2/config`

Size: 3258 lines across 16 file(s).
...
- `v2/config/inhive_option.go` (179 lines)
...
Size: 8695 lines across 31 file(s).

Files:
- `v2/hcore/bootstrap_fetch.go` (150 lines)
- `v2/hcore/buildconfighelper.go` (264 lines)
- `v2/hcore/commands.go` (587 lines)
- `v2/hcore/coreinfo.go` (45 lines)
- `v2/hcore/crash_output.go` (51 lines)
- `v2/hcore/custom.go` (43 lines)
- `v2/hcore/daita_machines.go` (16 lines)
- `v2/hcore/grpc_server.go` (374 lines)
- `v2/hcore/hcore_service_grpc.pb.go` (905 lines)
- `v2/hcore/hcore_service.pb.go` (153 lines)
- `v2/hcore/hcore.pb.go` (2889 lines)
- `v2/hcore/independent_instance.go` (434 lines)
- `v2/hcore/log_file.go` (129 lines)
- `v2/hcore/log_interface.go` (60 lines)
- `v2/hcore/log_level.go` (89 lines)
- `v2/hcore/log_shared.go` (77 lines)
- `v2/hcore/logproto.go` (75 lines)
- `v2/hcore/mem_sampler.go` (336 lines)
